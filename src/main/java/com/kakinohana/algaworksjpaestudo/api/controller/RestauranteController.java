...
import com.kakinohana.algaworksjpaestudo.domain.service.CadastroRestauranteService;
...
public class RestauranteController {
    ...
    public Restaurante atualizarParcial(@PathVariable("restauranteId") Long restauranteId, @RequestBody Map<String, Object> campos, HttpServletRequest request){
    ...
    public void excluir(@PathVariable("restauranteId") Long restauranteId){
